...
<head>
    ...
    <title>VICA</title>
    <link rel="stylesheet" href="<?= $url ?>/dist/assets/custom.css">
</head>
<body>
    <header>
        <div class="header-wrapper">
            <div class="header-top">
                ...
                <a class="contact" href="<?= home_url() ?>/lien-he">Liên hệ</a>
                <a class="sign-in" href="<?= home_url() ?>/dang-nhap">Đăng nhập</a>
            </div>
            <div class="logo-container">
                <a href="<?= home_url() ?>"><img src="<?= $url ?>/dist/images/logo.png" alt="VICA Logo" class="logo"></a>
            </div>
        ...
        <div class="header-mobile">
            <div class="logo">
                <a href=""><img src="<?= $url ?>/dist/images/logo.png" alt="VICA Logo" class="logo"></a>
            </div>
        ...
        <div id="menuHeader" class="menu-mobile">
            <div class="top">
                <img src="<?= $url ?>/dist/images/logo.png" alt="VICA Logo" class="logo">
            ...
            <nav class="nav-menu">
                <ul>
                    <li><a class="active" href="<?= home_url() ?>/about.php">Giới thiệu</a></li>
                    <li><a href="<?= home_url() ?>/member.php">Hội viên</a></li>
                    <li><a href="<?= home_url() ?>/training.php">Đào tạo</a></li>
                    <li><a href="<?= home_url() ?>/recruitment.php">Cơ hội việc làm</a></li>
                    <li><a href="<?= home_url() ?>/project.php">Dự án</a></li>
                    <li><a href="<?= home_url() ?>/database.php">Cơ sở dữ liệu</a></li>
