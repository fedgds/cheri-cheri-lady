    ...
    <section class="section-news">
        <div class="container-news">
            <div class="latest-news">
                ...
                <div class="list-news">
                    <div class="news-left">
                        <img src="<?= $url ?>/dist/images/new1.png" alt="">
                    ...
                    <div class="news-right">
                        <div class="news-top">
                            <img src="<?= $url ?>/dist/images/new2.png" alt="">
                            <div class="news-content">
                                <h3 class="title">
                        ...
                        <div class="news-bottom">
                            <img src="<?= $url ?>/dist/images/new3.png" alt="">
                            <div class="news-content">
                                <h3 class="title">
            ...
            <div class="bottom">
                ...
                <div class="right">
                    <div class="social-media">
                        <a href="" class="infor">
                            <img class="left" src="<?= $url ?>/dist/images/logo.png" alt="">
                            <div class="right">
                                <h3>VICA</h3>
